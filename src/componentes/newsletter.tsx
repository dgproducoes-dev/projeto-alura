import logo from '../assets/imagem/icone-mergulhador.svg';

const NewsLetter = () => (
  <body className="bg-azul-claro h-screen flex justify-center items-center">
    <main className="flex px-6 drop-shadow-2xl lg:w-3/4">
      <div className="bg-azul-escuro hidden lg:block w-1/2 rounded-l-lg">
        <img alt="" className="p-6 m-auto" src={logo} />
      </div>
